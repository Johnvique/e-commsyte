 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    ...
                    <div class="box" id="text-page">
                        <h1>More About Smart Super-Retail</h1>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="{{asset('img/detailsquare.jpg')}}" class="img-circle img-responsive" alt="">
                                </p>
                                <p class="text-center">circle</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="{{asset('img/detailsquare.jpg')}}" class="img-thumbnail  img-responsive" alt="">
                                </p>
                                <p class="text-center">thumbnail</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="{{asset('img/detailsquare.jpg')}}" class="img-rounded img-responsive" alt="">
                                </p>
