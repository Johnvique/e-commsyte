                            ...
                            <ul class="nav nav-pills nav-stacked category-menu">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{url('/#!')}}">Dresses</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('/#!')}}">Other Attires  <span class="badge pull-right">11</span></a>
                                    <ul>
                                        <li><a href="{{url('/#!')}}">Unfinished</a>
                                        </li>
                                        <li><a href="{{url('/#!')}}">Pants</a>
                                        </li>
                                        <li><a href="{{url('/#!')}}">Booty Shorts</a>
                                        </li>
                                        <li><a href="{{url('/#!')}}">Skirts</a>
                                        </li>
                                        <li><a href="{{url('/#!')}}">Bras</a>
                                        </li>
                                        <li><a href="{{url('/#!')}}">Sanitary Towels</a>
                                        </li>
                                    </ul>
                                </li>
