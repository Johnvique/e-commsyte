                    ...
                    <div class="product-slider">
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price"><del>ksh.10,000</del> ksh.30,500</p>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="{{url('/detail')}}">White Blouse Armani</a></h3>
                                    <p class="price"><del>ksh.12,500</del> ksh.150,000</p>
                                </div>
                                <!-- /.text -->
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('img/getinspired1.jpg')}}" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('img/getinspired2.jpg')}}" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('img/getinspired3.jpg')}}" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box text-center" data-animate="fadeInUp">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <p class="lead">What's new in the world of fashion? <a href="{{url('/post')}}">Check our blog!</a>
                        </p>
                    </div>
                </div>
            </div>
